      ...
      >
        ...
        <div className="flex items-center justify-between px-4 pb-3 border-b">
          ...
          <button
            ...
            type="button"
            onClick={onClose}
            className="p-2 -mr-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-safelight-500"
